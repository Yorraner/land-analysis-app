...
import pandas as pd
# edge of 153 phone
DEFAULT_COZE_TOKEN = "pat_uWH7YZK8nPduocJKB15VumzITg9GnjfQj51TUMxn7JTXl6u4Ta77CcibDDxVxcel"
COZE_CN_BASE_URL = "https://api.coze.cn"


WORKFLOW_CONFIG = {
    "整治潜力": "7574817225950822434",      # 您提供的潜力数据 Workflow ID
    "自然资源禀赋": "7541696293958729738",  # 您提供的自然资源禀赋 Workflow ID
    "存在问题": '7542773461622472739',  
    "子项目": '7543134980516380707' ,
    "空间布局": '7543555166965776394',}
